...
/**
 * Util class with constants to represent messages transmitted by exceptions or
 * other handlers.
 * 
...
public final class Message {
	...
	public static final String ERR_CANNOT_OBTAIN_DATASOURCE = "Cannot obtain DataSource";

	public static final String ERR_CANNOT_ROLLBACK = "Cannot rollback connection";
	...
	public static final String ERR_RESOURCE_NOT_FOUND = "Resource was not found -- %s";

	public static final String SERVICE_INITIALIZED = "%s service initialized and binded";

	public static final String ENCODING_IS_SET = "Request encoding set to %s";

	public static final String INVALID_USER_NAME_OR_PASSWORD = "message.invalid_email_pass";
	
	public static final String STATION_NOT_FOUND = "message.station_not_found";
	
	public static final String ERR_DATE_INCORRECT = "message.date_incorrect";
