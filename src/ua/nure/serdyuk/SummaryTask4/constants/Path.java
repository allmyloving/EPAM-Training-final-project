...
public final class Path {
	...
	public static final String ETICKET_NAME = "ticket.pdf";
	...
	public static final String ROUTE_VIEW = "/WEB-INF/jsp/admin/routesView.jsp";
	
	public static final String TRAIN_VIEW = "/WEB-INF/jsp/admin/trainsView.jsp";
	
	public static final String CARRIAGES_VIEW = "/WEB-INF/jsp/admin/carriagesView.jsp";
	...
	public static final String STATIONS_VIEW_COMMAND = "/controller?command=stationView";
	
	public static final String ROUTE_VIEW_COMMAND = "/controller?command=routeView";
	
	public static final String TRAIN_VIEW_COMMAND = "/controller?command=trainView";
	
	public static final String CARRIAGES_VIEW_COMMAND = "/controller?command=carriagesView";
